...
if __name__ == '__main__':
    ...
    for step in range(N_iter):
        ...
        if step % 100 == 0:
            ...
            imwrite(os.path.join(args.output, 'log_im_{}.png'.format(numLgtSGs)), im)

            np.save(os.path.join(args.output, 'sg_{}.npy'.format(numLgtSGs)), lgtSGs.clone().detach().cpu().numpy())